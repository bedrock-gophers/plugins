...
Included examples cover movement cancellation, chat mutation, lifecycle hooks, Dragonfly command registration, player latency queries, typed items, scoreboards, all Dragonfly form families, managed worlds, typed entity/projectile operations, and all built-in world particles.
