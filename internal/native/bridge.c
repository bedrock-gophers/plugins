...
_Static_assert(offsetof(DfInventoryMenuView, items) == 24, "DfInventoryMenuView.items ABI offset changed");
...
_Static_assert(DF_WORLD_REDSTONE_SCHEDULE_UPDATE == 0u, "redstone schedule-update operation changed");
...
extern DfStatus bg_go_player_inventory_menu_send(uint64_t context, DfInvocationId invocation, DfPlayerId player, uint8_t update, const DfInventoryMenuView *menu);
...
DfStatus bg_call_inventory_menu_submit(DfInventoryMenuSubmitFn callback, void *callback_context, DfInvocationId invocation, const DfPlayerSnapshot *submitter, const DfItemStackViewV3 *item) { return callback(callback_context, invocation, submitter, item); }
...
static DfStatus host_player_inventory_menu_send(uint64_t context, DfInvocationId invocation, DfPlayerId player, uint8_t update, const DfInventoryMenuView *menu) { return bg_go_player_inventory_menu_send(context, invocation, player, update, menu); }
