...
#define DF_HOST_ABI_VERSION 21u
...
typedef DfStatus (*DfPluginSetHostFn)(void *instance, const DfHostApiV21 *host);
...
typedef struct { DfStringView plugin_directory; const DfHostApiV21 *host; } DfRuntimeConfig;
