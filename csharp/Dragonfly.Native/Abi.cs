...
public static partial class Abi
{
    ...
    public const uint PlayerCooldownSet = 1;
    ...
    public const uint WorldRedstonePower = 0;
    public const uint WorldRedstoneDirectPower = 1;
    public const uint WorldRedstoneStrongPower = 2;
    public const uint WorldRedstoneConductivePower = 3;
...
public unsafe struct InventoryMenuView
{
    ...
    public void* CallbackContext;
    public delegate* unmanaged[Cdecl]<void*, ulong, PlayerSnapshot*, ItemStackViewV3*, int> Submit;
...
public unsafe struct HostApi
{
    ...
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, uint, PlayerStateValue, PlayerStateValue*, int> PlayerAction;
    ...
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, uint, StringView, int, long, byte*, int> PlayerCooldown;
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, Vec3, double, double, int> PlayerKnockBack;
    ...
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, uint, BlockPos, int, Vec3, int> PlayerBlockAction;
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, EntityId, uint, StringView, byte, int> PlayerViewLayer;
    ...
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, byte, InventoryMenuView*, int> PlayerInventoryMenuSend;
    public delegate* unmanaged[Cdecl]<ulong, ulong, PlayerId, int> PlayerInventoryMenuClose;
}

[StructLayout(LayoutKind.Sequential)]
public struct EntityAnimationView
{
    public StringView Name;
    public StringView NextState;
    public StringView Controller;
    public StringView StopCondition;
}
